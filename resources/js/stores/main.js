...
export const useMainStore = defineStore("main", {
  ...
  actions: {
    ...
    dismissNotification(){
      this.notificationIsDismissed = true;
    },
    unDismissNotification(){
      this.notificationIsDismissed = false;
    },
