    ...
    <LayoutAuthenticated>
        <SectionMain>
            ...
            <CardBox :is-form="true" @submit.prevent="submit">
                ...
                <FormField label="Product Name" :error="form.errors.title">
                    <FormControl v-model="form.title" placeholder="Enter Product Name..." />
                </FormField>
                ...
                <FormField label="Type" :error="form.errors.type">
                    <FormControl v-model="form.type" :options="[{id:0,label:'one'}]" />
                </FormField>
